...
public class GetMappingController {
    ...
    // 3.   @RequestParam
    @GetMapping("/method3")     // 경로상 : http://localhost:8080/get/method3?param1=안녕&param2=하하
    public String method3( @RequestParam String param1 ,  @RequestParam String param2){
        log.info("클라이언트로부터 받은 변수 : " +param1 + " " + param2);
        return "요청받은 데이터 : " +param1 + " " + param2;
    } // 리턴타입 String = text/plain;charset=UTF-8
    // 4.   @RequestParam
    @GetMapping("/method4")     // 경로상 : http://localhost:8080/get/method4?param1=안녕&param2=하하
    ...
    // 5. get메소드에서 Dto로 매개변수 한번에 요청시 @RequestParam @RequestBody 사용 불가
    @GetMapping("/method5")     // 경로상 : http://localhost:8080/get/method5?param1=안녕&param2=하하
    public ParamDto method5( ParamDto dto){
        log.info("클라이언트로부터 받은 변수 : " +dto);
        return dto;
    } // 리턴 타입 dto : Content-Type:	application/json
    //6.
    @GetMapping("/method6")     // 경로상 : http://localhost:8080/get/method6?param1=안녕&param2=하하
